...
import { AlignRight, Gift, MapPin, Minus, Plus } from "lucide-react";
...
export default function ProductDetail() {
    ...
    const [checkedSize, setCheckedSize] = useState('1')
    ...
    let price = 690000
    let subTotal = checkedSize === '0.5' ? (price * qty) / 2 : (price * qty)
    let totalPrice = checkedOption ? subTotal + 38000 : subTotal
                        ...
                        <div className="md:px-0 px-4">
                            ...
                            <div className="bg-pink-50 p-4">
                                <div className="flex justify-start gap-2 text-center flex-wrap">
                                    <div className="text-blue-500 font-bold text-xl">{subTotal}</div>
                            ...
                            <div className="my-5">
                                <div className="space-y-4">
                                    ...
                                    <RadioGroup defaultValue={checkedSize} onValueChange={(val) => setCheckedSize(val)}>
                            ...
                            <div className="mt-4">
                                <div className="font-bold flex justify-start mt-3">Số lượng:
                                    ...
                                    <input value={qty} min={1} className="w-3/12 text-center" onChange={(e) => { setQty(Number(e.target.value)) }} />
                            ...
                            <div className="py-4">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="space-y-3">
                                        <div className="flex items-center space-x-2">
                                            <Checkbox id="terms" checked={checkedOption} onCheckedChange={(checked) => setCheckedOption(!checkedOption)} />
                                            <label
                                                htmlFor="terms"
                                            ...
                                            >
                                                <div className="grid grid-cols-2 gap-2">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div>Phí nướng muối ớt 1</div>
                                                        <Select defaultValue="muoi ot 1">
                                                            <SelectTrigger className="w-full py-0">
                                                                <SelectValue placeholder="Select a fruit" />
                                                            </SelectTrigger>
                                                            <SelectContent >
                                                                <SelectGroup>
                                                                    <SelectItem value="muoi ot 1">{"1 món (< 500gram)"}</SelectItem>
                            ...
                            <div className="py-4 items-center text-end">
                                <div className="mb-3"><span className=" font-semibold">Tổng tiền:</span> <span className="font-bold text-blue-500">{totalPrice}đ</span></div>
                                <button
